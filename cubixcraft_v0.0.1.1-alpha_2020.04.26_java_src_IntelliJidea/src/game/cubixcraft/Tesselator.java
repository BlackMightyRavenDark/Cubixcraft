/*
 * Класс Tesselator это обёртка над glInterleavedArrays(), glDrawArrays()
...
public class Tesselator {
    ...
    private float arrayVertexQuads[];
    private float arrayTextureVertexQuads[];

    private FloatBuffer bufferArrayVertexQuads;
    private FloatBuffer bufferArrayTextureVertexQuad;
